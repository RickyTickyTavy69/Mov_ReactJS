    ...
    <>
                ...
                return (
                  <article className="home-item" key={uuidv4()}>
                    ...
                    <img
                      ...
                      src={
                        movie.poster_path
                          ? `${configData.IMG_URL}${movie.poster_path}`
                          : no_poster
                      }
                      alt=""
                    />
      ...
      {nameToSearch && (
        <section>
          ...
          {!searchResults.length && nameToSearch !== "Supercode" && (
            <h2 className="home-search__heading">No Search Results</h2>
          )}
            ...
            nameToSearch !== "Supercode" && (
              <article className="search-nores" key={uuidv4()}>
                ...
                <p className="search-nores__text">
                  Leider haben wir keinen Film, der{" "}
                  <strong>{nameToSearch}</strong> heißt. Falls es diesen Film
                  wirklich gibt, schreiben sie uns gerne eine Email.
                </p>
                <p className="home-search__text--thin"></p>
                <a
                  className="search-nores__link"
                  href="mailto:FilmDatenBank@fakeEmailBitteNixSenden.com"
                >
                  Email Us
                </a>
              </article>
          ...
          <section className="home-search-grid">
            <article className="home-search-item">
              ...
              <img
                ...
                alt=""
              />
              <p className="home-search__text--thin">2022</p>
